...
//                mPressedView.setPressed(true);
    ...
    private void setPressViewHotSpot(final MotionEvent e,final  View view) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            /**
             * when   click   Outside the region , view is null
             */
            if (view !=null && view.getBackground() != null) {
                view.getBackground().setHotspot(e.getRawX(), e.getY()-view.getY());
            }
        }
    }
